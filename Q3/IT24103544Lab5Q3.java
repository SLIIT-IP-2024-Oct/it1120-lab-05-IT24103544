...
public class IT24103544Lab5Q3 {
    ...
    public static final int disone = 10; // Discount for 3-4 days
    public static final int distwo = 20; // Discount for 5 or more days
    public static final int roompd = 48000; // Room charge per day
